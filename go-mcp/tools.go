...
type Args struct {
	Entity string         `json:"entity" jsonschema:"domain | mcp | pending_delete"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CatchdomsSecuritySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "catchdoms-security_list",
		Description: "List records from CatchdomsSecurity. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "catchdoms-security_load",
		Description: "Load a single record from CatchdomsSecurity. " +
...
func runOp(client *sdk.CatchdomsSecuritySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CatchdomsSecuritySDK, name string) (sdk.CatchdomsSecurityEntity, error) {
	...
	case "pending_delete":
		return client.PendingDelete(nil), nil
