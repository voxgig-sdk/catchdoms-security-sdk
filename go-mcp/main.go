// Command CatchdomsSecurity-mcp is an MCP server exposing the CatchdomsSecurity
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CatchdomsSecurity_list  — list records of an entity
//	CatchdomsSecurity_load  — load a single record of an entity
//
