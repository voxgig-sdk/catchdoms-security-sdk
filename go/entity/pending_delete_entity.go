...
type PendingDeleteEntity struct {
	name    string
	client  *core.CatchdomsSecuritySDK
...
func NewPendingDeleteEntity(client *core.CatchdomsSecuritySDK, entopts map[string]any) *PendingDeleteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PendingDeleteEntity) GetName() string { return e.name }
...
func (e *PendingDeleteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PendingDeleteEntity) Deleted() bool {
	return e.deleted
}


func (e *PendingDeleteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPendingDeleteEntity(e.client, opts)
}

func (e *PendingDeleteEntity) Data(args ...any) any {
...
func (e *PendingDeleteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PendingDelete; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PendingDeleteEntity) DataTyped(data ...PendingDelete) PendingDelete {
	if len(data) > 0 {
		return typedFrom[PendingDelete](e.Data(asMap(data[0])))
	}
	return typedFrom[PendingDelete](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PendingDelete (all fields
// optional at the wire level).
func (e *PendingDeleteEntity) MatchTyped(match ...PendingDelete) PendingDelete {
	if len(match) > 0 {
		return typedFrom[PendingDelete](e.Match(asMap(match[0])))
	}
	return typedFrom[PendingDelete](e.Match())
}
...
func (e *PendingDeleteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PendingDeleteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PendingDeleteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PendingDeleteListMatch and returns []PendingDelete. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PendingDeleteEntity) ListTyped(reqmatch PendingDeleteListMatch, ctrl map[string]any) ([]PendingDelete, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PendingDelete](res), nil
}



func (e *PendingDeleteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PendingDeleteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PendingDeleteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PendingDeleteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
