...
func NewMcpEntity(client *core.CatchdomsSecuritySDK, entopts map[string]any) *McpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *McpEntity) GetName() string { return e.name }
...
func (e *McpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *McpEntity) Deleted() bool {
	return e.deleted
}


func (e *McpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMcpEntity(e.client, opts)
}

func (e *McpEntity) Data(args ...any) any {
...
func (e *McpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Mcp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *McpEntity) DataTyped(data ...Mcp) Mcp {
	if len(data) > 0 {
		return typedFrom[Mcp](e.Data(asMap(data[0])))
	}
	return typedFrom[Mcp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Mcp (all fields
// optional at the wire level).
func (e *McpEntity) MatchTyped(match ...Mcp) Mcp {
	if len(match) > 0 {
		return typedFrom[Mcp](e.Match(asMap(match[0])))
	}
	return typedFrom[Mcp](e.Match())
}
...
func (e *McpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *McpEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *McpEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// McpListMatch and returns []Mcp. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *McpEntity) ListTyped(reqmatch McpListMatch, ctrl map[string]any) ([]Mcp, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Mcp](res), nil
}



func (e *McpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *McpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *McpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *McpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
