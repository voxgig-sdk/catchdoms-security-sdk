...
func TestMcpEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set CATCHDOMS_SECURITY_TEST_MCP_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func mcpBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("CATCHDOMS_SECURITY_TEST_MCP_ENTID")
