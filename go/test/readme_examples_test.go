...
const testSeed = `map[string]any{"entity": map[string]any{"domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mcp": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pending_delete": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
