...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CATCHDOMSSECURITY_TEST_LIVE ||
    'TRUE' === process.env.CATCHDOMSSECURITY_TEST_OVERRIDE
  ) {
  ...
  m.CATCHDOMSSECURITY_TEST_EXPLAIN = process.env.CATCHDOMSSECURITY_TEST_EXPLAIN || m.CATCHDOMSSECURITY_TEST_EXPLAIN
