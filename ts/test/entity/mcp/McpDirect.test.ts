...
describe('McpDirect', async () => {
  ...
  test('direct-list-mcp', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-mcp', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['CATCHDOMS_SECURITY_TEST_MCP_ENTID']
