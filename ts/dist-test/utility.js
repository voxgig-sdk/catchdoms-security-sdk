...
function envOverride(m) {
    if ('TRUE' === process.env.CATCHDOMS_SECURITY_TEST_LIVE ||
        'TRUE' === process.env.CATCHDOMS_SECURITY_TEST_OVERRIDE) {
    ...
    m.CATCHDOMS_SECURITY_TEST_EXPLAIN = process.env.CATCHDOMS_SECURITY_TEST_EXPLAIN || m.CATCHDOMS_SECURITY_TEST_EXPLAIN;
    return m;
}
