...
(0, node_test_1.describe)('PendingDeleteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CatchdomsSecuritySDK({
    ...
    (0, node_test_1.test)('direct-list-pending_delete', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-pending_delete', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CatchdomsSecuritySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.CATCHDOMS_SECURITY_APIKEY,
        }));
        let idmap = env['CATCHDOMS_SECURITY_TEST_PENDING_DELETE_ENTID'];
    ...
    const client = new __1.CatchdomsSecuritySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PendingDeleteDirect.test.js.map