...
(0, node_test_1.describe)('McpDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-mcp', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-mcp', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CATCHDOMS_SECURITY_TEST_MCP_ENTID'];
...
//# sourceMappingURL=McpDirect.test.js.map