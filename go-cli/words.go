...
func registerSDKWords(r *eng.Registry, client *sdk.CatchdomsSecuritySDK) {
...
func runOp(client *sdk.CatchdomsSecuritySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
