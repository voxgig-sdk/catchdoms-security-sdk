...
#      offline in seeded test mode (CatchdomsSecuritySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CatchdomsSecurity_sdk.rb")
  SDK_CLASS = "CatchdomsSecuritySDK"
  ...
  SDK_BASE = "CatchdomsSecurity_sdk"
