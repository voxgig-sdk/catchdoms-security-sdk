...
class McpEntity
  ...
  # @return [Mcp, Hash] the current Mcp data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Mcp fields)
  def match_get
  ...
  #
  # @param reqmatch [McpListMatch, Hash, nil] match filter (any subset of
  #   Mcp fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Mcp>, Array] the matching Mcp items; raises CatchdomsSecurityError on failure
