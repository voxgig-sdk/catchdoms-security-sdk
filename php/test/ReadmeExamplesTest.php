...
// CatchdomsSecurity SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CatchdomsSecuritySDK::test)
...
{
    private const SDK_CLASS = 'CatchdomsSecuritySDK';
    ...
    private const SDK_BASE = 'catchdomssecurity_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../catchdomssecurity_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
