...
class McpDirectTest extends TestCase
{
    public function test_direct_list_mcp(): void
    {
        $setup = mcp_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-mcp", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
