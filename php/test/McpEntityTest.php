...
class McpEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CATCHDOMSSECURITY_TEST_MCP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function mcp_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CATCHDOMSSECURITY_TEST_MCP_ENTID");
