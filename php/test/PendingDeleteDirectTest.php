...
class PendingDeleteDirectTest extends TestCase
{
    public function test_direct_list_pending_delete(): void
    {
        $setup = pending_delete_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-pending_delete", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
