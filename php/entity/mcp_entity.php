...
// CatchdomsSecurity SDK Mcp entity
...
class McpEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new McpEntity($this->_client, $opts);
    }

    /**
     * @param Mcp|array $args Mcp data (assoc-array) to store.
     */
    ...
    /**
     * @return Mcp|array The current Mcp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Mcp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Mcp fields).
     */
    ...
    /**
     * List Mcp items matching the given filter.
     *
     * @param McpListMatch|array|null $reqmatch Match filter (any subset
     *   of Mcp fields) as an assoc-array; McpListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mcp[]|array A list of Mcp items as assoc-arrays at
