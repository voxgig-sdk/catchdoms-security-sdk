...
// CatchdomsSecurity SDK utility: fetcher

class CatchdomsSecurityFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CatchdomsSecuritySDK/1.0)';
    ...
    public static function call(CatchdomsSecurityContext $ctx, string $fullurl, array $fetchdef): array
    {
