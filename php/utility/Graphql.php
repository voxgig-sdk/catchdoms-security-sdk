...
// CatchdomsSecurity SDK utility: graphql
//
...
class CatchdomsSecurityGraphql
{
    ...
    // equivalent.
    public static function body(CatchdomsSecurityContext $ctx): mixed
    {
    ...
    public static function errors(CatchdomsSecurityContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
