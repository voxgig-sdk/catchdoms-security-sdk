...
// CatchdomsSecurity SDK proxy feature
...
class CatchdomsSecurityProxyFeature extends CatchdomsSecurityBaseFeature
{
    ...
    public function init(CatchdomsSecurityContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CatchdomsSecurityContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
