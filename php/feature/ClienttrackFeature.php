...
// CatchdomsSecurity SDK clienttrack feature
...
class CatchdomsSecurityClienttrackFeature extends CatchdomsSecurityBaseFeature
{
    ...
    public function PostConstruct(CatchdomsSecurityContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CatchdomsSecurity-SDK';
