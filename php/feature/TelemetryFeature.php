...
// CatchdomsSecurity SDK telemetry feature
...
class CatchdomsSecurityTelemetryFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _close(CatchdomsSecurityContext $ctx, bool $ok): void
    {
