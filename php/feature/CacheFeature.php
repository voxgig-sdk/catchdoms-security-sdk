...
// CatchdomsSecurity SDK cache feature
...
class CatchdomsSecurityCacheFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _through(CatchdomsSecurityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
