...
// CatchdomsSecurity SDK rbac feature
...
class CatchdomsSecurityRbacFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _required(CatchdomsSecurityContext $ctx): ?string
    {
    ...
    private function _reject(CatchdomsSecurityContext $ctx, string $required): void
    {
    ...
    private function _track(CatchdomsSecurityContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
