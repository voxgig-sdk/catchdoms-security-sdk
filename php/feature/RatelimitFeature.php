...
// CatchdomsSecurity SDK ratelimit feature
...
class CatchdomsSecurityRatelimitFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _acquire(CatchdomsSecurityContext $ctx): void
    {
    ...
    private function _track(CatchdomsSecurityContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
