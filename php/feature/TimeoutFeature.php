...
// CatchdomsSecurity SDK timeout feature
...
class CatchdomsSecurityTimeoutFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _with_timeout(CatchdomsSecurityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CatchdomsSecurityContext $_ctx, float $ms): void
    {
        $client = $this->client;
