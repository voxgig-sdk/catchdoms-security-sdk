...
// CatchdomsSecurity SDK metrics feature
...
class CatchdomsSecurityMetricsFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _record(CatchdomsSecurityContext $ctx, bool $ok): void
    {
