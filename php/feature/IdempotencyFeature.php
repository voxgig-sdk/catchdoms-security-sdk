...
// CatchdomsSecurity SDK idempotency feature
...
class CatchdomsSecurityIdempotencyFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _mutating(CatchdomsSecurityContext $ctx): bool
    {
