...
// CatchdomsSecurity SDK audit feature
...
class CatchdomsSecurityAuditFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _emit(CatchdomsSecurityContext $ctx, string $outcome): void
    {
