...
|---|---|---|
| `ts/` | @voxgig-sdk/catchdoms-security-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/catchdoms-security-sdk \
      --repository voxgig-sdk/catchdoms-security-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/catchdoms-security-sdk` shows it, and
`npm trust revoke @voxgig-sdk/catchdoms-security-sdk --id=<id>` removes it.
