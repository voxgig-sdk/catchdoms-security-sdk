...
class CatchdomsSecurityTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CatchdomsSecurityTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CatchdomsSecurityTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CatchdomsSecurityTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
