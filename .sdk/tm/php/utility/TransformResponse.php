...
// CatchdomsSecurity SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CatchdomsSecurityTransformResponse
{
    public static function call(CatchdomsSecurityContext $ctx): mixed
    {
        ...
        $transform = CatchdomsSecurityHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
