...
// CatchdomsSecurity SDK pipeline test
//
...
{
    private static function utility(): CatchdomsSecurityUtility
    {
        return new CatchdomsSecurityUtility();
    }
    ...
    private static function ctx(array $over = []): CatchdomsSecurityContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CatchdomsSecurityContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CatchdomsSecurityOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CatchdomsSecurityError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CatchdomsSecurityOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CatchdomsSecurityMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CatchdomsSecurityOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CatchdomsSecurityMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CatchdomsSecurityOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CatchdomsSecurityMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CatchdomsSecuritySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CatchdomsSecurityMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CatchdomsSecurityResponse([]),
            'result' => new CatchdomsSecurityResult([]),
        ]);
        [, $err] = CatchdomsSecurityMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CatchdomsSecuritySpec([]),
            'response' => null,
            'result' => new CatchdomsSecurityResult([]),
        ]);
        [, $err] = CatchdomsSecurityMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CatchdomsSecuritySpec(['step' => 's']),
            'response' => new CatchdomsSecurityResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CatchdomsSecurityResult([]),
        ]);
        [, $err] = CatchdomsSecurityMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CatchdomsSecuritySpec(['step' => 's']),
            'response' => new CatchdomsSecurityResponse(self::resp(200, ['v' => 1])),
            'result' => new CatchdomsSecurityResult([]),
        ]);
        [, $err] = CatchdomsSecurityMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CatchdomsSecuritySpec(['step' => 's']),
            'response' => new CatchdomsSecurityResponse(self::resp(200, ['v' => 2])),
            'result' => new CatchdomsSecurityResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CatchdomsSecurityMakeResponse::call($ctx);
    ...
    {
        $preset = new CatchdomsSecurityResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CatchdomsSecuritySpec([]),
            'response' => new CatchdomsSecurityResponse([]),
            'result' => new CatchdomsSecurityResult([]),
        ...
        [$got, $err] = CatchdomsSecurityMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CatchdomsSecurityResult([])]);
        [, $err] = CatchdomsSecurityMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CatchdomsSecuritySpec([]), 'result' => null]);
        [, $err] = CatchdomsSecurityMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CatchdomsSecuritySpec(['step' => 's']),
            'result' => new CatchdomsSecurityResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CatchdomsSecurityOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CatchdomsSecurityMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CatchdomsSecuritySpec(['step' => 's']),
            'result' => new CatchdomsSecurityResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CatchdomsSecurityOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CatchdomsSecurityMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CatchdomsSecurityResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CatchdomsSecuritySpec([]),
            'result' => new CatchdomsSecurityResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CatchdomsSecurityMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CatchdomsSecurityMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CatchdomsSecurityError('boom', 'boom');
        $utility->fetcher = function (CatchdomsSecurityContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CatchdomsSecuritySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CatchdomsSecurityMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CatchdomsSecurityContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CatchdomsSecurityMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CatchdomsSecurityResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CatchdomsSecurityMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CatchdomsSecurityContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CatchdomsSecuritySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CatchdomsSecurityMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CatchdomsSecurityResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CatchdomsSecuritySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CatchdomsSecurityMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CatchdomsSecurityMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CatchdomsSecurityMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CatchdomsSecurityResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CatchdomsSecurityDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CatchdomsSecurityResult(['ok' => false])]);
        $this->expectException(CatchdomsSecurityError::class);
        CatchdomsSecurityDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CatchdomsSecurityResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CatchdomsSecurityMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CatchdomsSecurityMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CatchdomsSecurityBaseFeature();
        $b = new CatchdomsSecurityBaseFeature();
        CatchdomsSecurityFeatureAdd::call($ctx, $a);
        CatchdomsSecurityFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CatchdomsSecurityBaseFeature
    {
        $f = new CatchdomsSecurityBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CatchdomsSecurityFeatureAdd::call($ctx, self::named_feature('a'));
        CatchdomsSecurityFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        CatchdomsSecurityFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        CatchdomsSecurityFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        CatchdomsSecurityFeatureAdd::call($ctx, $replace);
        ...
        CatchdomsSecurityFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CatchdomsSecurityContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CatchdomsSecuritySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CatchdomsSecurityPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CatchdomsSecurityPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CatchdomsSecurityResponse(['headers' => null]),
            'result' => new CatchdomsSecurityResult([]),
        ]);
        CatchdomsSecurityResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CatchdomsSecurityResultBody::call($ctx);
