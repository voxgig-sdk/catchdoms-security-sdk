...
// CatchdomsSecurity SDK netsim feature
...
class CatchdomsSecurityNetsimFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _simulate(CatchdomsSecurityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CatchdomsSecurityContext $ctx, array $applied): void
    {
        $client = $this->client;
