...
// CatchdomsSecurity SDK streaming feature
...
class CatchdomsSecurityStreamingFeature extends CatchdomsSecurityBaseFeature
{
    ...
    private function _iterate(CatchdomsSecurityResult $result): \Generator
    {
    ...
    private function _streamable(CatchdomsSecurityContext $ctx): bool
    {
