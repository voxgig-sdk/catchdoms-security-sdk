...
// CatchdomsSecurity SDK utility type

class CatchdomsSecurityUtility
{
    ...
    public static function copy(CatchdomsSecurityUtility $src): CatchdomsSecurityUtility
    {
        $u = new CatchdomsSecurityUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
