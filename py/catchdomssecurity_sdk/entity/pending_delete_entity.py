...
from catchdomssecurity_sdk.catchdomssecurity_types import (
    PendingDelete,
...
class PendingDeleteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PendingDeleteEntity(self._client, opts)
    ...
    def data_get(self) -> PendingDelete:
    ...
    def match_get(self) -> PendingDelete:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PendingDelete]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PendingDelete().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
