...
from catchdomssecurity_sdk.core.control import CatchdomsSecurityControl
...
from catchdomssecurity_sdk.core.helpers import get_ctx_prop, to_map
...
class CatchdomsSecurityContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CatchdomsSecurityControl()
        ...
        if isinstance(sp, CatchdomsSecuritySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CatchdomsSecurityResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CatchdomsSecurityResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CatchdomsSecurityOperation({})
    ...
    def make_error(self, code, msg):
        return CatchdomsSecurityError(code, msg, self)
