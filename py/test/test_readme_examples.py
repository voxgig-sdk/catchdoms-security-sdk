# CatchdomsSecurity SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CatchdomsSecuritySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CatchdomsSecuritySDK(...) and CatchdomsSecuritySDK.test(...) become
#      CatchdomsSecuritySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "catchdomssecurity_sdk"
_SDK_CLASS = "CatchdomsSecuritySDK"
