...
describe("PendingDeleteDirect", function()
  it("should direct-list-pending_delete", function()
    local setup = pending_delete_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-pending_delete", setup.live and "live" or "unit")
...
function pending_delete_direct_setup(mockres)
