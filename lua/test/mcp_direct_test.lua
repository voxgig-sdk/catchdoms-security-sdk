...
describe("McpDirect", function()
  it("should direct-list-mcp", function()
    local setup = mcp_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-mcp", setup.live and "live" or "unit")
...
function mcp_direct_setup(mockres)
