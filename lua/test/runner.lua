...
function runner.env_override(m)
  local live = runner.getenv("CATCHDOMS_SECURITY_TEST_LIVE")
  local override = runner.getenv("CATCHDOMS_SECURITY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CATCHDOMS_SECURITY_TEST_EXPLAIN")
