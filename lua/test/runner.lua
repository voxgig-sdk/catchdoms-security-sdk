...
function runner.env_override(m)
  local live = runner.getenv("CATCHDOMSSECURITY_TEST_LIVE")
  local override = runner.getenv("CATCHDOMSSECURITY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CATCHDOMSSECURITY_TEST_EXPLAIN")
